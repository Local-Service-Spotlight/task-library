---
name: run-weekly-client-seo-audits
description: "A dated per-client pass/fail audit, with recurring failures distinguished from new findings."
category: Website QA Audit
stage: —
definitive_article: https://blitzmetrics.com/how-to-run-weekly-ai-agent-seo-audits-across-all-your-clients/
status: needs-work
---

# Run weekly client SEO audits

**Use this when:** The agreed weekly audit schedule fires for a verified in-scope client list.

This is a registered recipe in review. A published guide or this new record does not certify its runtime behavior. Read the current [canonical procedure](https://blitzmetrics.com/how-to-run-weekly-ai-agent-seo-audits-across-all-your-clients/) before executing; it contains the detailed actions and current source-specific instructions.

## Inputs
- Authorized client/site scope
- Live site URLs
- Last audit
- Verified project thread and publishing authority
...
- [How to QA a Personal Brand Website](https://blitzmetrics.com/website-qa-audit/)
- [How to Do MAA (Metrics, Analysis, Action) Like a Pro](https://blitzmetrics.com/maa/)
## Steps
1. Read the authorized run list.
2. Crawl each live site.
3. Score each checklist item.
4. Compare with the previous audit.
...
- [ ] Every check has a specific result and explanation
- [ ] Resolved and unresolved prior findings are identified
- [ ] The findings exist in the intended project thread
...
The team prioritizes and fixes findings; the next weekly audit verifies the result.
...
## Open review items
- Body currently calls a Google Sheet the sole active-client authority. Reconcile that sentence with the current Client Roster before adding a new block.
...
- Canonical task procedure: https://blitzmetrics.com/how-to-run-weekly-ai-agent-seo-audits-across-all-your-clients/
- Exact Task Library record: https://local-service-spotlight.github.io/task-library/?task=run-weekly-client-seo-audits#task-run-weekly-client-seo-audits
...
Source basis: canonical article WordPress ID 104709; reviewed source SHA-256 `0dbafef384df5230e95211fb7ceef9d9595ffc95c5979bd3f41f531422062c26`. The task record summarizes that source and keeps its unresolved items visible. It does not certify installations, provider commands, source-system access or a completed run.
